...
from . import views
from .views import read_lef_view, model_data_view, read_registered_lxf, read_meet_manager,list_TeamManager_by_Meet
...
urlpatterns = [
    ...
    path('lxf-delete/', views.LXFTeamView.as_view(), name='delete-meet'),
